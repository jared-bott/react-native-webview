...
const RNCWebView: typeof NativeWebViewWindows = requireNativeComponent(
  'RNCWebView',
);

class WebView extends React.Component<WindowsWebViewProps, State> {
  static defaultProps = {
  ...
  componentDidUpdate(prevProps: WindowsWebViewProps) {
    this.showRedboxOnPropChanges(prevProps, 'mediaPlaybackRequiresUserAction');
  }

  showRedboxOnPropChanges(
    prevProps: WindowsWebViewProps,
    propName: keyof WindowsWebViewProps,
  ) {
